...
namespace ProductsAPI.Migrations
{
    ...
    [Migration("20241007185540_RisksTableSetter")]
    partial class RisksTableSetter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductsAPI.Data.RiskEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ProductsAPI.Data.RiskEntity", b =>
                {
                    b.HasOne("ProductsAPI.Models.AppUser", "AppUser")
                        .WithOne("Risk")
                        .HasForeignKey("ProductsAPI.Data.RiskEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
